      ...
      {#if mounted}
        <div in:fly={{ y: -20, duration: 800 }} class="space-y-8">
          ...
          <div class="flex items-center gap-4 justify-center">
            <h1 class="text-7xl font-bold text-transparent bg-gradient-to-r from-white to-white/80 bg-clip-text">yaerguOS</h1>
            <img src="/lilypad.png" alt="lilypad" class="h-24 w-auto animate-float" style="animation: float 3s ease-in-out infinite;" />
          </div>
    ...
    <div class="container mx-auto px-4 relative">
      <div class="flex flex-col md:flex-row justify-between items-center gap-6 text-white/60">
        ...
        <div class="flex gap-8">
          <a href="https://github.com/yaerguos" class="hover:text-white transition-all duration-200 hover:-translate-y-1">
            <span class="flex items-center gap-2">
          ...
          <a href="https://discord.gg/yaerguos" class="hover:text-white transition-all duration-200 hover:-translate-y-1">
            <span class="flex items-center gap-2">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://twitter.com/yaerguos" class="hover:text-white transition-all duration-200 hover:-translate-y-1">
            <span class="flex items-center gap-2">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
